    ...
    <div id="about" className='section-layout'>
      <div className='brand-statement'>
        ...
        <ul className='my-info'>
          ...
          <li>Recently completed a <b>full time, 480+ hour, 12 week Software Engineering Immersive</b> at <a href='https://generalassemb.ly/education/software-engineering-immersive/seattle?ga_campaign=immersive-remote&ga_variation=sei-tile' target='_blank'>General Assembly</a></li>
          <li>Last full time position was doing <b>Android Development</b> as a Software Engineer at <a href='https://willowtreeapps.com/' target='_blank'>WillowTree</a></li>
          ...
          <li>Attended the <a href='https://www.rit.edu/computing/school-interactive-games-and-media' target='_blank'>Rochester Institute of Technology</a>, specifically the Golisano College of Information Technology and Science.</li>
