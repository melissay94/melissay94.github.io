    ...
    <div id="about" className='section-layout'>
      <div className='brand-statement'>
        ...
        <ul className='my-info'>
          ...
          <li>Recently completed a <b>full time, 480+ hour, 12 week Software Engineering Immersive</b> at 
          ...
          <li>Attended the
            ...
            </a>, specifically the Golisano College of Information Technology and Science.</li>
